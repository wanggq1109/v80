...
<title>《${topic.title }》 - 摄影作品 - 80视觉</title>
...
<script type="text/javascript">$(document).ready(function(){var fix = $("#Header");fix.scrollFix();$('.nav .two').addClass('cur');});</script>
...
<div id="main">
  	<div class="container">
   		<div id="canonicals">
    		<div class="header">您现在的位置：<a href="index.action">首页</a> > <a href="photography_list.action">作品赏析</a> > <a href="">一周推荐</a></div>
    		<div class="show">
     			<div class="title">
     			...
     			<div class="cbox">
        			<div class="about">拍摄时间：${psDate} 拍摄地点：${topic.shotAddress} 摄影师：${topic.cameraman } 造型师：${topic.stylists }</div>
      				<div class="intro"><p>描述：${topic.photTopicDesc}</p></div>
     				<div class="photolist">
      					<ul class="gallery">
     					<s:iterator value="photographyList" var="photo" status="t">
                    ...
                    <div class="comment">
                      <!-- 多说评论框 start -->
	<div class="ds-thread" data-thread-key="${topic.id}" data-title="${topic.title }" data-url="<%=basePath%>photoListforTopic.action?id=${topic.id}"></div>
<!-- 多说评论框 end -->
