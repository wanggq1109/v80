...
<title>《${topic.title }》 - 热门景点- 80视觉</title>
...
<script type="text/javascript">$(document).ready(function(){var fix = $("#Header");$('.nav .six').addClass('cur');fix.scrollFix();});</script>
...
<div id="main">
  	<div class="container">
   		<div id="canonicals">
    		<div class="header">您现在的位置：<a href="index.action">首页</a> > <a href="hotspotsshow_init.action">热门景点</a></div>
    		<div class="show">
     			<div class="title">
     			...
     			<div class="cbox">
        			<div class="about">拍摄时间：${psDate} 拍摄地点：${topic.shotAddress} 摄影师：${topic.cameraman } 造型师：${topic.stylists }</div>
     				...
     				<div class="photolist">
      					<ul class="gallery">
     					<s:iterator value="hotspotsList" var="photo" status="t">
                    ...
                    <div class="comment">
                      <!-- 多说评论框 start -->
	<div class="ds-thread" data-thread-key="${topic.id}" data-title="${topic.title }" data-url="<%=basePath%>hotspotscontent_init.action?id=${topic.id}"></div>
<!-- 多说评论框 end -->
